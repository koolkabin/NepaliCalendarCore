...
namespace NUnitTestProj
{
    public class ConvertTests
    {
        ...
        public void Test2000101Eng()
        {
            ...
            var res = NepaliCalendar.Utils.Convert.ToEnglish(nDate);
        ...
        public void Test19440413Nep()
        {
            ...
            var res = NepaliCalendar.Utils.Convert.ToNepali(eDate);
        ...
        public void TestAdd1Month()
        {
            ...
            var res = NepaliCalendar.Utils.Convert.AddMonths(nDate, 1);
            Assert.AreEqual(res, eDate);
        }
        [Test]
        public void TestAdd1Month_2()
        {
            ...
            var res = NepaliCalendar.Utils.Convert.AddMonths(nDate, 17);
            Assert.AreEqual(res, eDate);
        }
        [Test]
        public void TestAdd24Days_2()
        {
            ...
            var res = NepaliCalendar.Utils.Convert.AddDays(nDate, 24);
            Assert.AreEqual(res, eDate);
        }
        [Test]
        public void TestAdd5Month()
        {
            ...
            var res = NepaliCalendar.Utils.Convert.AddMonths(nDate, 5);
            Assert.AreEqual(res, eDate);
        }
        [Test]
        ...
        public void TestAdd3MonthEOM432()
        {
            ...
            var res = NepaliCalendar.Utils.Convert.AddMonths(nDate, 3);
            Assert.AreEqual(res, eDate);
        }
        [Test]
        ...
        public void TestEachNewYearNepUpto2000()
        {
            ...
            var res = nDate.OfType<string>().ToList().Select(x => NepaliCalendar.Utils.Convert.ToEnglish(x)).ToArray();
        ...
        public void TestEachNewYearEngUpto2000()
        {
            ...
            var res = eDate.OfType<DateTime>().ToList().Select(x => NepaliCalendar.Utils.Convert.ToNepali(x)).ToArray();
            for (var i = 0; i < nDate.Length; i++)
            {
        ...
        public void TestMonthDayCount0()
        {
            ...
            var res = NepaliCalendar.Utils.Convert.GetMonthDayCount(nDate);
